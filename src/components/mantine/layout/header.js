import {AppShell, Avatar, Button, Burger, Group, Menu, rem, Text, UnstyledButton, useMantineColorScheme} from "@mantine/core";
...
export default function SurtricsHeader ({ mobileOpened, toggleMobile, desktopOpened, toggleDesktop}) {
