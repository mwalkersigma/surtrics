...
const RangeView = () => {
    ...
    const [[startDate,endDate],setDateRange] = useState([new Date('01-01-2024'),new Date()]);
    ...
    let direction = dataForTrend[0] < dataForTrend[dataForTrend.length-1] ? colorScheme.green : 'red';
