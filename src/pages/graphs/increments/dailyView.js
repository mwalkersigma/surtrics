...
import {Container, SimpleGrid, Stack, useMantineColorScheme, Grid, Space, Skeleton,Title} from "@mantine/core";
                ...
                <Grid.Col span={2}>
                    <Stack>
                        <StatsCard
                            stat={{
                                title:"Total",
                                value:formatter(chartData.reduce((a,b) => a + b,0)),
                            }}/>
                        <StatsCard
                            stat={{
                                title:"Average",
                        ...
                        <StatsCard
                            stat={{
                                title:"Best Hour",
                                value:formatter(chartData.reduce((a,b) => a > b ? a : b,0)),
                            }}/>
                        <StatsCard
                            stat={{
                                title:"New Inbound",
                                value:formatter(dailyData
